...
![MVVM](https://7n.w3cschool.cn/attachments/image/wk/vuejs1.0/mvvm.png) 
...
![1539274803139](assets/1539274803139.png)
...
效果true:![1539274919001](assets/1539274919001.png)

效果false:![1539274937768](assets/1539274937768.png)
...
组件系统是 Vue.js 另一个重要概念，因为它提供了一种抽象，让我们可以用独立可复用的小组件来构建大型应用。如果我们考虑到这点，几乎任意类型的应用的界面都可以抽象为一个组件树： ![Component Tree](https://7n.w3cschool.cn/attachments/image/wk/vuejs1.0/components.png) 
